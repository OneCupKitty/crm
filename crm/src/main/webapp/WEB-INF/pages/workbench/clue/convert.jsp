	...
	<script type="text/javascript">
		$(function(){
			...
			$("#searchActivityTxt").keyup(function () {
				selectActivityByNameAndClueId(this.value)
			});
		...
		//查询线索已经关联的市场活动
		selectActivityByNameAndClueId=function (activityName) {
			//收集参数
...
<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
	...
	<form>
		...
		<div class="form-group" style="width: 400px;position: relative; left: 20px;">
			...
			<input type="text" class="form-control" id="activityName" placeholder="点击搜索市场活动" readonly>
		</div>
	</form>
...
<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
	<input class="btn btn-default" id="back" type="button" value="取消">
</div>
</body>
</html>